...
```{r linked-tsne-full, out.width=ifelse(knitr::is_html_output(), "100%", "\\textwidth"), fig.cap="Linked visuals of the tour using \\\\pkg{detourr} (left) compared to a T-SNE dimension reduction (right)"}
