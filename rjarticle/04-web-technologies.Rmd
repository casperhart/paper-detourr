...
To address this, \pkg{detourr} uses TensorFlow.js (@abadi2016tensorflow) as the main library for storing data and projection matrices and performing matrix operations. TensorFlow.js requires the user to choose between one of three available backends:
