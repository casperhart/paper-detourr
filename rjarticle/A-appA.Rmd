...
```{r, radial-cdf-p, fig.cap = "Relative projected volume for projections from p dimensions to d=3 dimensions. The solid line is simulated data, and the dashed line is the theoretical CDF", out.width="70%", fig.align="center"}
plot_data <- bind_rows(
...
```{r, radial-cdf-d, fig.cap = "Relative projected volume for a projection of p=10 dimensions to d dimensions.  The solid line is simulated data, and the dashed line is the theoretical CDF. This shows the generalisation to d > 3 dimensions", out.width="70%", fig.align="center"}
plot_data <- bind_rows(
